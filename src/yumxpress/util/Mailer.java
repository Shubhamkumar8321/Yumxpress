...
public class Mailer {
    ...
    public static void sendMail(StaffPojo staff) throws MessagingException {
        final String username = "webdev0507@gmail.com";
        final String password = "bhio dobi bzfa ybvs";
        ...
        String emailBody = "Dear " + staff.getStaffName() + ",\n"
                ...
                + "Staff password: " + PassEncryption.getDecryptedPassword(staff.getPassword()) + "\n"
                + "\n"
    ...
    public static void sendMailToCustomer(CustomerPojo customer) throws MessagingException {
        final String username = "webdev0507@gmail.com"; //emailCredentials.get("emailId");
        final String password = "bhio dobi bzfa ybvs";//emailCredentials.get("securityKey");
        MyAuthenticator myAuth = new MyAuthenticator(username, password);
        Session session = Session.getInstance(prop, myAuth);
        Message message = new MimeMessage(session);
        message.setRecipients(
        ...
        String emailBody = "Dear " + customer.getCustomerName() + ",\n"
                ...
                + "Customer password: " + PassEncryption.getDecryptedPassword(customer.getPassword()) + "\n"
                + "\n"
